...
export default function petajkt(){
    ...
    const [dinamis,setDinamis] = useState({
      ...
      jakartaselatan: ['mbloc','mrt','pim','scbd'],
      jakartapusat: ['katredal','gn','bni','jamdinding','monas','mrts','pasar'],
    ...
    let angkaRan = {
      ...
      jakartaselatan: Math.floor(Math.random() * 4),
      jakartapusat: Math.floor(Math.random() * 7),
    ...
    useEffect(() => {
      let angkaRan = {
        jakartabarat: Math.floor(Math.random() * 4),
        jakartatimur: Math.floor(Math.random() * 5),
        jakartaselatan: Math.floor(Math.random() * 4),
        jakartapusat: Math.floor(Math.random() * 7),
        jakartautara: Math.floor(Math.random() * 5)
      ...
      if(pusherChannel && pusherChannel.bind){
        ...
        pusherChannel.bind('chat-event', (pusherData) => {
          ...
          setTimeout(()=>{
            ...
            document.querySelector('.'+dat.daerah+' .mark.m-'+dinamis[dat.daerah.replace(/-/g, '')][angkaRan[dat.daerah.replace(/-/g, '')]]).classList.add('animasi-naikturun')
            setData(pusherData.data.data)
            setTimeout(function() {
              klikmarker(dat.daerah,dinamis[dat.daerah.replace(/-/g, '')][angkaRan[dat.daerah.replace(/-/g, '')]],'50%',dat)
              setTimeout(function(){
                document.querySelector('.'+dat.daerah+' .mark.m-'+dinamis[dat.daerah.replace(/-/g, '')][angkaRan[dat.daerah.replace(/-/g, '')]]).classList.remove('animasi-naikturun')
                    if(kembali.jenis == "0"){
    ...
    const kembalikan = (output) =>{
      ...
      setAspirasi((prev)=>({
        ...prev,
        [output.daerah.replace(/-/g, '')]: output.aspirasi
      }))
    }
  ...
  interval = setInterval(() => {
    ...
    const klikmarker = (e,a,p,user) => {
      ...
      document.querySelector('.'+e +' .mark.m-'+a).style.display = 'block'
      document.querySelector('.'+e +' .mark.m-'+a).classList.add('animasi-naikturun')
      console.log(document.querySelector('.'+e +' .mark.m-'+a))
      document.querySelector('.'+e +' .'+a).style.opacity = '1'
      setKembali(prev=>({
        ...prev,
        jenis: "1",
      ...
      setAspirasi((prev)=>({
        ...prev,
        [user.daerah.replace(/-/g, '')]: user.aspirasi
      }))
    }
    ...
    return (
       <div className="flex justify-between h-screen align-center relative" style={{backgroundImage: `url('/bg.png')`,backgroundRepeat: 'repeat',overflow: 'hidden'}}>
        ...
        <style>
          ...
          <h1 onTransitionEnd={(e)=>animateText(e)} data-value={aspirasi.jakartautara}style={{width:'40%',fontSize: '200%',position: 'absolute',right: '-120%', bottom: '13%',transition: 'all 1s',opacity: '0'}}>{aspirasi.jakartautara}</h1>
          <h1 className="absolute top-0 left-0" style={{left: '44vw',whiteSpace: 'nowrap',fontSize:'250%'}}>JAKARTA UTARA</h1>
...

          {
            user.jakartautara.map(el=>{
              return(
                <img src="/mark.png" className={"absolute mark m-"+dinamis.jakartautara[angkaRan.jakartautara]} onClick={()=> klikmarker('jakarta-utara',dinamis.jakartautara[angkaRan.jakartautara],'50%',el)} style={{width: '10%',top: 32 + ((45 - 32) * (el.x / 100))+'%',right:  -52 + ((-15 - -52) * (el.x / 100))+'%'}}></img>
              )
            })
          }
        ...
        <div className="jakarta-barat parent-provinsi absolute" style={{transition: 'all 0.5s'}}>
          ...
          <h1 onTransitionEnd={(e)=>animateText(e)} data-value={aspirasi.jakartabarat}style={{width:'40%',fontSize: '200%',position: 'absolute',right: '-120%', bottom: '13%',transition: 'all 1s',opacity: '0'}}>{aspirasi.jakartabarat}</h1>
          <h1 className="absolute top-0" style={{left: '44vw',whiteSpace: 'nowrap',fontSize:'240%'}}>JAKARTA BARAT</h1>
...

          {
            user.jakartabarat.map(el=>{
              return(
                <img src="/mark.png" className={"absolute mark m-"+dinamis.jakartabarat[angkaRan.jakartabarat]} onClick={()=> klikmarker('jakarta-barat',dinamis.jakartabarat[angkaRan.jakartabarat],'50%',el)} style={{width: '10%',top: (el.y * ((84 - 23) / 100)) + 23+'vh',right:  -32 + ((9 - -32) * (el.x / 100))+'%'}}></img>
              )
            })
          }
        ...
        <div className="jakarta-timur parent-provinsi absolute" style={{transition: 'all 0.5s',marginTop: '3%'}}>
          ...
          <h1 onTransitionEnd={(e)=>animateText(e)} data-value={aspirasi.jakartatimur}style={{width:'40%',fontSize: '200%',position: 'absolute',right: '-120%', bottom: '8%',transition: 'all 1s',opacity: '0'}}>{aspirasi.jakartatimur}</h1>

          <h1 className="absolute top-0" style={{left: '44vw',whiteSpace: 'nowrap',fontSize:'240%',top: '-7%'}}>JAKARTA TIMUR</h1>
          ...
          <img className="peta-prov" style={{width: '50vw',height: '90vh',objectFit: 'contain',position: 'relative',left: '50%',overflow: 'hidden'}} src="/zoom_jaktim.png"></img>
          {
            user.jakartatimur.map(el=>{
              return(
                <img src="/mark.png" className={"absolute mark m-"+dinamis.jakartatimur[angkaRan.jakartatimur]} onClick={()=> klikmarker('jakarta-timur',dinamis.jakartatimur[angkaRan.jakartatimur],'50%',el)} style={{width: '10%',top: (el.y * ((80 - 11) / 100)) + 11+'vh',right: (el.x * ((10 - -5) / 100)) + -5+'vw'}}></img>
              )
            })
          }
        </div>
        ...
        <div className="jakarta-selatan parent-provinsi absolute" style={{transition: 'all 0.5s',marginTop: '5%'}}>
          ...
          <h1 onTransitionEnd={(e)=>animateText(e)} data-value={aspirasi.jakartaselatan}style={{width:'40%',fontSize: '200%',position: 'absolute',right: '-120%', bottom: '13%',transition: 'all 1s',opacity: '0'}}>{aspirasi.jakartaselatan}</h1>
          <h1 className="text-4xl absolute top-0 left-0" style={{left: '44vw',whiteSpace: 'nowrap',fontSize:'240%',top: '-10%'}}>JAKARTA SELATAN</h1>
          <img className="peta-prov" style={{width: '50vw',height: '80vh',objectFit: 'contain',position: 'relative',left: '50%',overflow: 'hidden'}} src="/zoom_jaksel.png"></img>
          {
            user.jakartaselatan.map(el=>{
              return(
                <img src="/mark.png" className={"absolute mark m-"+dinamis.jakartaselatan[angkaRan.jakartaselatan]} onClick={()=> klikmarker('jakarta-selatan',dinamis.jakartaselatan[angkaRan.jakartaselatan],'50%',el)} style={{width: '10%',top: (el.y * ((43 - 6) / 100)) + 6+'vh',right: (el.x * ((6 - -15) / 100)) + -15+'vw'}}></img>
              )
            })
          }
        </div>
        ...
        <div className="jakarta-pusat parent-provinsi absolute" style={{transition: 'all 0.5s',marginTop: '5%'}}>
          ...
          <h1 onTransitionEnd={(e)=>animateText(e)} data-value={aspirasi.jakartapusat}style={{width:'40%',fontSize: '200%',position: 'absolute',right: '-120%', bottom: '13%',transition: 'all 1s',opacity: '0',top: '50%'}}>{aspirasi.jakartapusat}</h1>
          <h1 className="absolute top-0 left-0" style={{left: '44vw',whiteSpace: 'nowrap',fontSize:'240%',top: '-11%'}}>JAKARTA PUSAT</h1>
...

          {
            user.jakartapusat.map(el=>{
              return(
                <img src="/mark.png" className={"absolute mark m-"+dinamis.jakartapusat[angkaRan.jakartapusat]} onClick={()=> klikmarker('jakarta-pusat',dinamis.jakartapusat[angkaRan.jakartapusat],'50%',el)} style={{width: '10%',top: (el.y * ((43 - 6) / 100)) + 6+'vh',right: (el.x * ((6 - -15) / 100)) + -15+'vw'}}></img>
              )
            })
          }
        </div>
        ...
        <div className="relative">
            <div className="absolute bottom-0" style={{width: '20%',left: '10%',top: '15%'}}>
              <img className="peta peta-jakarta-barat" style={{zIndex: '10',position: 'relative'}} onClick={(el)=> setZoom(el,'jakarta-barat')} src="/jabar.png"></img>
              {
                user.jakartabarat.map(el=>{
                  return(
                    <img src="/mark.png" className="absolute mark-utama" style={{width: '50%',top: -30 + ((100 - -30) * (el.y / 100))+'%',right: -7 + ((35 - -7) * (el.x / 100))+'%'}}></img>
                  )
                })
              }
            ...
            <div className="absolute bottom-0" style={{width: '20%',right: '15%',top: '8%'}}>
              <img className="peta peta-jakarta-utara" style={{zIndex: '10',position: 'relative'}} onClick={(el)=> setZoom(el,'jakarta-utara')} src="/jakut.png"></img>
              {
                user.jakartautara.map(el=>{
                  return(
                    <img src="/mark.png" className="absolute mark-utama" style={{width: '50%',top: -48 + ((100 - -48) * (el.y / 100))+'%',right: -5 + ((25 - -5) * (el.x / 100))+'%'}}></img>
                  )
                })
              }
